...
def most_and_least_common_type(treats):
    ...
    ('dessert', 'drink')
    >>> treats=[{'type': 'dessert'}, {'type': 'drink'},{'type': 'appetizer'}, {'type': 'dessert'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'drink')
    >>> treats=[{'type': 'dessert'}, {'type': 'appetizer'},{'type': 'drink'}, {'type': 'dessert'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'appetizer')
    >>> treats=[]
    >>> most_and_least_common_type(treats)
    (None, None)
    >>> treats=[{'type': 'dessert'}, {'type': 'dessert'},{'type': 'dessert'}, {'type': 'dessert'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'dessert')
    >>> treats=[{'type': 'dessert'}, {'type': 'drink'},{'type': 'dessert'}, {'type': 'appetizer'}, {'type':'appetizer'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'drink')
    """
